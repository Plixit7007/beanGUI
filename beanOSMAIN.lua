-- maybe gonna be updated frequently?? and maybe have an app creation system

local tscreen = GetPartFromPort(1, "TouchScreen")

local appframeHidden = false
